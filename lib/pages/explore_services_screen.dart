...
class _ExploreServicesScreenState extends State<ExploreServicesScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<ServiceProvider>().loadAllServices().then((_) {
        _performSearch();
      });
    });
  }
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    '⚠️ Atenção: Desconfie de valores muito abaixo do mercado. Não faça pagamentos antecipados sem garantias.',
                    style: TextStyle(
                      fontSize: 11,
